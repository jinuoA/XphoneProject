    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='phone_auth.UserInfo', verbose_name=b'\xe7\x94\xa8\xe6\x88\xb7')),
            ],
            options={
                'ordering': ['-date_publish'],
                'verbose_name': '\u8bc4\u8bba',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_publish', models.DateTimeField(auto_now_add=True, verbose_name=b'\xe5\x8f\x91\xe5\xb8\x83\xe6\x97\xb6\xe9\x97\xb4')),
                ('collect_count', models.IntegerField(default=0, verbose_name='\u6536\u85cf\u6b21\u6570')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='phone_auth.UserInfo', verbose_name=b'\xe7\x94\xa8\xe6\x88\xb7')),
            ],
            options={
                'verbose_name': '\u65b0\u95fb',
        ...
        migrations.AddField(
            model_name='article',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='phone_auth.UserInfo', verbose_name=b'\xe7\x94\xa8\xe6\x88\xb7'),
        ),
    ]
